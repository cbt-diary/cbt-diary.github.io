...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.wasm_data_analysis = factory();
    }
}( this, function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_0e82c5814577c0ca0b18e087294e61ae0fe911f5": function($0, $1, $2, $3, $4, $5) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);$5 = Module.STDWEB_PRIVATE.to_js($5);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). id = ($2); ($3). classList.add ("flexible-list-element"); ($4). innerHTML = ($5);})());
            },
    ...
    function __instantiate( instance ) {
        ...
        Module.exports.on_toml_file_loaded = function on_toml_file_loaded(file_content) {
    Module.instance.exports.on_toml_file_loaded(Module.STDWEB_PRIVATE.prepare_any_arg(file_content));
}
;
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'wasm_data_analysis'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'wasm_data_analysis':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "wasm_data_analysis.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "wasm_data_analysis.wasm" )
