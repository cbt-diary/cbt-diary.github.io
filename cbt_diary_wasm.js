...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_2bdb35390f70f11f571d5d6a55c61d955bb5785f": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){var blob = new Blob ([($1)], {type : "text/plain;charset=utf-8"}); saveAs (blob , ($2));})());
            },
            ...
            "__extjs_819082345e6bcad8e659afa9ac31d3a8250e3194": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return moment (). format ();})());
            },
            ...
            "__extjs_f048333e51b1e288ec1c2e20952c19190268aecc": function($0, $1) {
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'cbt_diary_wasm'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'cbt_diary_wasm':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "cbt_diary_wasm.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "cbt_diary_wasm.wasm" )
